...
import { adminBroadcast, getAllSubscribers, deleteSubscriber, getSubscriberEmails } from '../controllers/marketingController.js';
...
router.get('/subscribers/emails', isAdmin, getSubscriberEmails);
router.delete('/subscribers/:id', isSuperAdmin, deleteSubscriber);
